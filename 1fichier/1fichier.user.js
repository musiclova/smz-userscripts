...
function main() {
    ...
    {
        var img_alert = '<div id="div_alert" style="position: fixed; bottom: 0px; right: 15px; z-index: 3000;">'
                + '<img id="img_alert" src="http://i.imgur.com/KAq6KFL.png" title="Highlight suspicious files">'
                + '</div>';
        ...
        var interval = window.setInterval(function() {
            if ($('#dirTree > .jqFT').length === 1 && $('#fileTree > #sable').length === 1) {
                ...
                $('#tabs-1').bind('mousedown.namespace', function(e) {
